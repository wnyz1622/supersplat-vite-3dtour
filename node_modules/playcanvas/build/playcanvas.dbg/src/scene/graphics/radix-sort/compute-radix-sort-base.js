...
class ComputeRadixSortBase {
  ...
  constructor(device, indirect = false) {
     ...
     * @type {boolean}
     */
    __publicField(this, "_indirect", false);
    /**
     ...
     * @protected
     */
    __publicField(this, "_hasInitialValues", false);
    /**
     ...
     * @protected
     */
    __publicField(this, "_skipLastPassKeyWrite", false);
    /**
     ...
     * @protected
     */
    __publicField(this, "_destructiveKeys", false);
    /**
     ...
     * @protected
     */
    __publicField(this, "_keys0", null);
    /**
     ...
     * @protected
     */
    __publicField(this, "_keys1", null);
    /**
     ...
     * @protected
     */
    __publicField(this, "_values0", null);
    /**
     ...
     * @protected
     */
    __publicField(this, "_values1", null);
    /**
     ...
     * @protected
     */
    __publicField(this, "_indirectInfo", new Uint32Array(4));
    this.device = device;
