...
`;
var compute_gsplat_interval_cull_default = computeGsplatIntervalCullSource;
export {
	computeGsplatIntervalCullSource,
	compute_gsplat_interval_cull_default as default
};
