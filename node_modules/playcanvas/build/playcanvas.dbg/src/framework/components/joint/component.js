...
class JointComponent extends Component {
  constructor() {
     ...
     * @private
     */
    __publicField(this, "_constraint", null);
    /** @private */
  ...
  _tryCreateConstraint() {
    ...
    if (this._constraint || !this._initialized || !this.enabled || !this.entity.enabled || this._broken || !this._entityA || this._entityA === this._entityB) {
  ...
  _createConstraint() {
    ...
    if (Number.isFinite(this._breakImpulse)) {
      ...
      this.system._breakable.add(this);
      Debug.call(() => {
        if (this._type === JOINTTYPE_6DOF && typeof constraint.isEnabled !== "function" && typeof constraint.getAppliedImpulse !== "function") {
