 ...
 * });
 */
__publicField(ElementDragHelper, "EVENT_DRAGSTART", "drag:start");
/**
 ...
 * });
 */
__publicField(ElementDragHelper, "EVENT_DRAGEND", "drag:end");
/**
 ...
 * });
 */
__publicField(ElementDragHelper, "EVENT_DRAGMOVE", "drag:move");
export {
  ElementDragHelper
};
